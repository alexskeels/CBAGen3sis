...
trait_names = c("dispersal", "temp_mean", "temp_width")
...
temp_omega <- 0.1 # environmental filtering parameter [0, n]
inflection <- 0.1 # extinction parameter: inflexion point of extinction probability curve
