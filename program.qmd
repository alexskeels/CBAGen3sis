...
Welcome to the CBA sponsored workshop on the Gen3sis biodiversity simulation software. We'll be using this Quarto book to navigate through the workshop. Quarto allows us to embed R code throughout. We'll be (roughly) following this program.
...
-   9am - Lecture 2. Alex and Oskar (Platypus Room) - Inference from biodiversity data
